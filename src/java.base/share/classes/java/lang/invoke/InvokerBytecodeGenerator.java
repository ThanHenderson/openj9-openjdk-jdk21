...
import java.lang.invoke.InvokerBytecodeGenerator.BytecodeGenerationException;
import java.lang.invoke.InvokerBytecodeGenerator.ClassData;
...
class InvokerBytecodeGenerator {
    ...
    private InvokerBytecodeGenerator(LambdaForm lambdaForm, int localsMapSize,
        ...
        this.name = name;
        String rawUniqueID = name + invokerName + invokerType.toString() + lambdaForm.toString();
        ...
        this.className = CLASS_PREFIX + name + "$" + encodedUniqueID.toString();
